...
@NamedQueries({
    ...
    @NamedQuery(name = "validar", query = "SELECT a FROM Administrador a WHERE a.chrAdmPassword = :ps AND a.chrAdmLogin = :us"),
...
public class Administrador implements Serializable {
    ...
    public String toString() {
        return "a2.entidades.Administrador[ chrAdmCodigo=" + chrAdmCodigo + " ]";
    }
