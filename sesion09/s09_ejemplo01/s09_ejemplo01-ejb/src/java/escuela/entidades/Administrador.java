...
@NamedQueries({
    ...
    @NamedQuery(name = "Administrador.validar", query = "SELECT a FROM Administrador a WHERE a.chrAdmLogin = :u AND a.chrAdmPassword = :p"),
...
public class Administrador implements Serializable {
    ...
    public String toString() {
        return "escuela.fachada.Administrador[ chrAdmCodigo=" + chrAdmCodigo + " ]";
    }
