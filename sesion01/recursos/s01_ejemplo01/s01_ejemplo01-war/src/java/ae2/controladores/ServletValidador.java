...
public class ServletValidador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String sUser = request.getParameter("txtUsuario");
        String sPass = request.getParameter("txtPassword");
        try (PrintWriter out = response.getWriter()) {
            /* TODO output your page here. You may use following sample code. */
            out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletValidador</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>" + abl.validarLocal(sUser, sPass) + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
